...
V2009 <- read.csv("RawData/comptagevelo2009.csv",header = TRUE, sep = ",", dec = ".",stringsAsFactors = FALSE)
V2010 <- read.csv("RawData/comptagevelo2010.csv",header = TRUE, sep = ",", dec = ".",stringsAsFactors = FALSE)
V2011 <- read.csv("RawData/comptagevelo2011.csv",header = TRUE, sep = ",", dec = ".",stringsAsFactors = FALSE)
V2012 <- read.csv("RawData/comptagevelo2012.csv",header = TRUE, sep = ",", dec = ".",stringsAsFactors = FALSE)
V2013 <- read.csv("RawData/comptagevelo2013.csv",header = TRUE, sep = ",", dec = ".",stringsAsFactors = FALSE)
V2014 <- read.csv("RawData/comptagevelo2014.csv",header = TRUE, sep = ",", dec = ".",stringsAsFactors = FALSE)
V2015 <- read.csv("RawData/comptagevelo2015.csv",header = TRUE, sep = ",", dec = ".",stringsAsFactors = FALSE)
V2016 <- read.csv("RawData/comptagevelo2016.csv",header = TRUE, sep = ",", dec = ".",stringsAsFactors = FALSE)
V2017 <- read.csv("RawData/comptagevelo2017.csv",header = TRUE, sep = ",", dec = ".",stringsAsFactors = FALSE)
V2018 <- read.csv("RawData/comptagevelo2018.csv",header = TRUE, sep = ",", dec = ".",stringsAsFactors = FALSE)
V2019 <- read.csv("RawData/comptagevelo2019.csv",header = TRUE, sep = ",", dec = ".",stringsAsFactors = FALSE)
V2020 <- read.csv("RawData/comptagevelo2020.csv",header = TRUE, sep = ",", dec = ".",stringsAsFactors = FALSE)
V2021 <- read.csv("RawData/comptagevelo2021.csv",header = TRUE, sep = ",", dec = ".",stringsAsFactors = FALSE)
V2022 <- read.csv("RawData/comptagevelo2022.csv",header = TRUE, sep = ",", dec = ".",stringsAsFactors = FALSE)
V2023 <- read.csv("RawData/comptagevelo2023.csv",header = TRUE, sep = ",", dec = ".",stringsAsFactors = FALSE)
LOC <- read.csv("RawData/localisation_des_compteurs_velo.csv",header = TRUE, sep = ",", dec = ".",stringsAsFactors = FALSE)
